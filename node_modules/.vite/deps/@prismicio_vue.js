...
// node_modules/@prismicio/client/dist/PrismicError.js
...
// node_modules/@prismicio/helpers/dist/asDate.js
...
// node_modules/@prismicio/types/dist/value/richText.js
...
// node_modules/@prismicio/types/dist/value/link.js
var LinkType = {
  Any: "Any",
  Document: "Document",
  Media: "Media",
...
// node_modules/@prismicio/helpers/dist/documentToLinkField.js
...
// node_modules/@prismicio/helpers/dist/asLink.js
...
// node_modules/@prismicio/richtext/dist/asTree.js
var uuid = () => {
...
// node_modules/@prismicio/richtext/dist/asText.js
...
// node_modules/@prismicio/richtext/dist/serialize.js
...
// node_modules/@prismicio/richtext/dist/types.js
...
// node_modules/@prismicio/richtext/dist/wrapMapSerializer.js
...
// node_modules/@prismicio/richtext/dist/composeSerializers.js
...
// node_modules/@prismicio/helpers/dist/asText.js
...
// node_modules/@prismicio/helpers/dist/lib/serializerHelpers.js
...
// node_modules/@prismicio/helpers/dist/asHTML.js
...
// node_modules/@prismicio/helpers/dist/isFilled.js
...
// node_modules/@prismicio/helpers/dist/asImageSrc.js
...
// node_modules/@prismicio/helpers/dist/asImageWidthSrcSet.js
...
// node_modules/@prismicio/helpers/dist/asImagePixelDensitySrcSet.js
...
// node_modules/@prismicio/client/dist/lib/appendPredicates.js
...
// node_modules/@prismicio/client/dist/ForbiddenError.js
var ForbiddenError = class extends PrismicError {
};

// node_modules/@prismicio/client/dist/NotFoundError.js
var NotFoundError = class extends PrismicError {
};

// node_modules/@prismicio/client/dist/ParsingError.js
var ParsingError = class extends PrismicError {
};

// node_modules/@prismicio/client/dist/predicate.js
...
var Client = class {
  constructor(repositoryNameOrEndpoint, options = {}) {
    ...
    __publicField2(this, "graphqlFetch", this.graphQLFetch.bind(this));
  ...
  async getFirst(params) {
    ...
    if (!(params && params.page) && !(params == null ? void 0 : params.pageSize)) {
      actualParams.pageSize = (_a2 = (_a = this.defaultParams) == null ? void 0 : _a.pageSize) != null ? _a2 : 1;
    }
...
// node_modules/@prismicio/vue/dist/lib/simplyResolveComponent.js
var simplyResolveComponent = (component) => {
  return resolveDynamicComponent(component);
};

// node_modules/@prismicio/vue/dist/components/PrismicEmbed.js
...
// node_modules/@prismicio/vue/dist/lib/__PRODUCTION__.js
if (typeof process === "undefined") {
  globalThis.process = { env: {} };
}
var __PRODUCTION__ = false;

// node_modules/@prismicio/vue/dist/injectionSymbols.js
var prismicKey = Symbol("prismic");

// node_modules/@prismicio/vue/dist/usePrismic.js
var usePrismic = () => {
  return inject(prismicKey, { options: { endpoint: "" } });
};

// node_modules/@prismicio/vue/dist/components/PrismicImage.js
...
var usePrismicImage = (props) => {
  ...
  const asImage = computed(() => {
    ...
    if (!isFilled_exports.image(field)) {
      return {
        src: null,
        srcset: null
      };
...
// node_modules/@prismicio/vue/dist/lib/isInternalURL.js
...
// node_modules/@prismicio/vue/dist/lib/getSlots.js
...
// node_modules/@prismicio/vue/dist/components/PrismicLink.js
...
// node_modules/@prismicio/vue/dist/components/PrismicText.js
var defaultWrapper2 = "div";
var usePrismicText = (props) => {
  const text = computed(() => {
    var _a;
    const field = unref(props.field);
    if (!isFilled_exports.richText(field)) {
...
var PrismicTextImpl = defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      const parent = simplyResolveComponent(props.wrapper || defaultWrapper2);
...
// node_modules/@prismicio/vue/dist/components/PrismicRichText.js
var defaultWrapper3 = "div";
...
var PrismicRichTextImpl = defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      return h(simplyResolveComponent(props.wrapper || defaultWrapper3), {
...
// node_modules/@prismicio/vue/dist/components/SliceZone.js
...
// node_modules/@prismicio/vue/dist/createPrismic.js
    ...
    client = createClient(options.endpoint, {
      fetch: async (endpoint, options2) => {
        ...
        if (typeof globalThis.fetch === "function") {
          ...
          fetchFunction = (await import("./browser-MSSEPG4R.js")).default;
        }
...
// node_modules/@prismicio/vue/dist/useStatefulPrismicClientMethod.js
var isParams = (value) => {
...
// node_modules/@prismicio/vue/dist/composables.js
